...
class WebAutomationPlaywright:
        ...
        try:
            ...
            try:
                ...
                if customer_field.count() > 0:
                    ...
                    print(f"⚠️ ไม่พบฟิลด์ Customer ID (iptcontactname)")
                ...
                # 6. เลือกดรอปดาวน์ภาษี (แตกต่างกันตาม company_vat_status)
    ...
    def process_pdf_data(self, pdf_data_list: list, start_index: int = 0) -> bool:
        ...
        try:
            print(f"📊 เริ่มประมวลผลข้อมูล PDF: {len(pdf_data_list)} ไฟล์")
            ...
            for i, pdf_data in enumerate(pdf_data_list, 1):
                ...
                if self.fill_form_data(pdf_data):
                    ...
                    result = self.wait_for_save_result(timeout=12)
                    if result == 'duplicate':
                        ...
                        print("⚠️ ไม่พบผลบันทึกภายในเวลา ก้าวต่อไปไฟล์ถัดไป")
                        time.sleep(0.2)
                        continue
                        ...
                        if self.upload_file_directly(new_pdf_filename):
                            ...
                            if self.wait_for_processing():
                                ...
                                try:
                                    ...
                                    # ใช้ company_vat_status ในการกำหนดโฟลเดอร์ปลายทาง
                                    # VAT → 'regular' → เอกสาร Vat
                                    # NoneVat → 'special' → เอกสาร NoneVat
                                    if company_vat_status == 'VAT':
                                        move_group = 'regular'
                                    else:
                                        move_group = 'special'
    ...
    def execute_peak_engine_workflow(self, pdf_data_list: list, main_folder: str) -> bool:
        ...
        try:
            ...
            # อ่านข้อมูลการตั้งค่าจากไฟล์ Build000.txt
            config_file_path = f"{main_folder}/รหัส/Build000.txt"
    ...
    def wait_for_save_result(self, timeout: int = 12) -> str:
