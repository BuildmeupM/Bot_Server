                ...
                if (data.success) {
                    ...
                    if (data.comparisons && data.comparisons.length > 0) {
                        ...
                        allComparisons.forEach((comp, index) => {
                            ...
                            if (ocrReadFailed) {
                                console.log(`🔍 [Debug] OCR อ่านไม่ได้สำหรับรายการที่ ${index + 1} (เลขที่ใบกำกับ: ${comp.purchase_data?.invoice_no || comp.invoice_no || 'N/A'}) - ผู้ใช้สามารถกดปุ่ม "ตรวจด้วยตัวเอง" เพื่อตรวจสอบได้`);
                            }
                        });
        ...
        function generateComparisonRowHTML(comp, index, tabName = 'all') {
            ...
            if (ocrReadFailed) {
                ...
                console.log(`🔍 [Debug] OCR อ่านไม่ได้สำหรับรายการที่ ${index + 1} (เลขที่ใบกำกับ: ${invoiceNo}) - ผู้ใช้สามารถกดปุ่ม "ตรวจด้วยตัวเอง" เพื่อตรวจสอบได้`);
