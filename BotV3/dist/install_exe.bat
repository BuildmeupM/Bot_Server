...
if exist "..\BotV3_Desktop.exe" copy "..\BotV3_Desktop.exe" "BotV3_Desktop.exe"
if exist "..\BotV3_Web.exe" copy "..\BotV3_Web.exe" "BotV3_Web.exe"
...
if exist "BotV3_Desktop.exe" echo   - BotV3_Desktop.exe (Desktop App)
if exist "BotV3_Web.exe" echo   - BotV3_Web.exe (Web Control)
echo.
pause
